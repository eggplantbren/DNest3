...
and see if a file called {\tt SpikeSlab} has been created. If so, everything worked
correctly.
...
directory and execute {\tt SpikeSlab}. You should see some output that looks like
...
The executable {\tt SpikeSlab} is responsible for the exploration part of the
...
After {\tt SpikeSlab} has been running for
...
{\tt ./SpikeSlab -h}. Here is the list:
...
levels). To execute DNest with 8 threads, simply use {\tt ./SpikeSlab -t 8}. You can
...
8 threads and a seed of 42, use {\tt ./SpikeSlab -t 8 -s 42}.
